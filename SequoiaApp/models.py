...
class Remitter(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="Remitter", default=1)
...
class Customer(models.Model):
    ...
    GSTIN = models.CharField(max_length=15, blank=True)
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="Customer", default=1)
...
class RTGS(models.Model):
    ...
    cheque_number = models.CharField(max_length=16, blank=False)
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="RTGS", default=1)
